                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-gray-900/50 rounded-xl p-4 border border-gray-700/50">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <button
                                    onClick={() => {
                                        navigator.clipboard.writeText('wget -O postman-like.deb https://github.com/vishalvishwakarma6688/desktop-application-postman/releases/download/v1.2.7/Postman-Like-linux.deb && sudo dpkg -i postman-like.deb || sudo apt-get install -f -y');
                                    }}
                            ...
                            <code className="text-xs text-gray-300 break-all block">
                                wget -O postman-like.deb https://github.com/vishalvishwakarma6688/desktop-application-postman/releases/download/v1.2.7/Postman-Like-linux.deb && sudo dpkg -i postman-like.deb || sudo apt-get install -f -y
                            </code>
                        </div>
                        ...
                        <div className="bg-gray-900/50 rounded-xl p-4 border border-gray-700/50">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <button
                                    onClick={() => {
                                        navigator.clipboard.writeText('wget -O postman-like.AppImage https://github.com/vishalvishwakarma6688/desktop-application-postman/releases/download/v1.2.7/Postman-Like-linux.AppImage && chmod +x postman-like.AppImage && ./postman-like.AppImage');
                                    }}
                            ...
                            <code className="text-xs text-gray-300 break-all block">
                                wget -O postman-like.AppImage https://github.com/vishalvishwakarma6688/desktop-application-postman/releases/download/v1.2.7/Postman-Like-linux.AppImage && chmod +x postman-like.AppImage && ./postman-like.AppImage
                            </code>
                        </div>
                    </div>
                </div>
